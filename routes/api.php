...
use App\Http\Controllers\Api\WorldTrackController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/worlds/{world}/track', [WorldTrackController::class, 'store'])->name('worlds.track.store');
    Route::delete('/worlds/{world}/track', [WorldTrackController::class, 'destroy'])->name('worlds.track.destroy');
    ...
    Route::prefix('assistants/{assistant}')->group(function () {
        ...
        Route::put('/discord/servers/{guildId}/prompt', [DiscordController::class, 'updateServerPrompt'])->name('discord.servers.updatePrompt');
        Route::put('/discord/channels/{channelId}/prompt', [DiscordController::class, 'updateChannelPrompt'])->name('discord.channels.updatePrompt');
