...
- [ ] T012 [US1] Create `app/Actions/BuildResidentWorldPrompt.php` with `worldState(World $world, WorldResident $resident, array $resolvedState): string` producing the section from T011: her zone in detail (description, objects, activities) and other zones by name and floor only, within 2,000 characters (FR-009)
