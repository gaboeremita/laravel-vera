...
import ImageGenModelAccordion from './ImageGenModelAccordion.jsx';
import SchemaEditor from './SchemaEditor.jsx';

export default function ImageGenProviderAccordion({
												  provider,
												  onUpdate,
												  onSave,
												  onDelete,
							...
							<div className="space-y-3 mt-3">
								...
								<div>
									...
									<input
										...
										className="w-full bg-bg-1 border border-line-1 text-accent text-sm px-3 py-2 outline-none focus:border-accent/50 transition-colors"
										placeholder="e.g. https://openrouter.ai/api/v1/images"
									/>
								</div>
								...
								<div>
									...
									<input
										...
										className="w-full bg-bg-1 border border-line-1 text-accent text-sm px-3 py-2 outline-none focus:border-accent/50 transition-colors"
										placeholder={provider.hasKey ? '••••••••  (leave blank to keep current)' : 'Enter API key (leave blank for Ollama)'}
									/>
								</div>
								...
								<div>
									...
									>
										...
										<option value="openai_compatible">OpenAI-Compatible (OpenAI, Ollama, ...)</option>
									</select>
								</div>
