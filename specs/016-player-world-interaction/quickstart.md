...
3. **Run and crouch**: hold Shift down the living room. Speed roughly doubles, the view widens slightly, and walls still stop you. Press Q: the view drops and you creep at half speed with `Q — STAND UP` shown. Press Q again to stand; crouch again and hold Shift to spring into a run. In The Index reading hall, jump onto a table, walk along it, and step off the edge back to the floor; jump under a low shelf and bump your head.
...
11. **Conversation**: open a chat with a resident standing with her back to you. She turns to face you; circle her and she keeps her direction, so you see her from the side and behind. Ask her to strike a pose: she turns to you first. Sit at the bar: `*sits down at the bar counter*` appears in the chat and she replies. Ask "what am I doing?": she says you are sitting at the bar. Ask her to go to the kitchen: she walks facing forward and keeps the direction she arrives with. A resident seated on a stool keeps facing the counter.
